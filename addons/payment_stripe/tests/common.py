...
class StripeCommon(PaymentCommon):
    ...
    def setUpClass(cls):
        ...
        cls.stripe = cls._prepare_provider('stripe', update_values={
            'stripe_secret_key': 'REDACTED_TEST_KEY_KJtHgNwt2KS3xM7QJPr4O5E8',
            'stripe_publishable_key': 'REDACTED_TEST_KEY_QSPnimmb4ZhtkEy3Uhdm4S6J',
            'stripe_webhook_secret': 'REDACTED_TEST_KEY_vG1fL6CMUouQ7cObF2VJprLVXT5jBLxB',
